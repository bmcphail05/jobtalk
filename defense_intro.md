...
Hi everyone, thanks so much. I want to briefly introduce my dissertation project, which I have titled "THE ECOLOGICAL EFFECTS OF RELIGION ON HEALTH AND MORTALITY IN CHINA." In this project, as the title suggest, I conceptualize religion as ecological characteristic, as a feature of groups, communities, or geographic areas and I examine how it is related to health and mortality outcomes, specifically in mainland China. For decades, researchers have shown links between an individual's personal religion and their health. And for decades, scholars have known that the social environments where people live, work, and play matter more for their health than their genes and biology. But very little research has examined how the religious environment, how the religious make-up of the place where someone lives affects their health. Or as Dan might say it, "how your neighbors' religion affects your health."

[SLIDE]
Here are two maps of China that represent my thinking on this project. The map on the left shows the mortality rates in Chinese prefectures and the map on the right shows the predominant religion in Chinese prefectures. Just as there is geographic variation in health and mortality across China, there is also geographic variation in religion. And connecting the variation in local health outcomes with the variation in local religious environments is what my dissertation project is all about. It sets out to examine whether and how the religious characteristics of local geographic areas is associated with health and mortality of the people living in them.

So far only a few scholars have studied how the religious environment affects population health and mortality in the U.S. (Blanchard et al. 2008; Garcia, Bartkowski, and Xu 2017; Stroope and Baker 2018), and we know very little about how this plays out in other social, political, and cultural contexts, so my dissertation extends to this work to mainland China, which as you see on these maps, has significant geographic health inequalities and it a very religiously diverse society.
...
First, I conceptualize religion as characteristic of a place, and I use the term "religious environment" to describe the demographic presence and socio-cultural influence of religion(s) in a local social environment (Blanchard et al. 2008: 1595)—most commonly a geographic area. This helps distinguish between religion’s individual and contextual or ecological effects, with the difference being between an INDIVIDUAL's religion affecting their health vs. their COMMUNITY's religion affecting their health.

How exactly then does the religious environment impact the health of individuals?

To answer this question, I use an socio-ecological framework and argue that religion place is a characteristic of the social environment that provides opportunities for social support, social influence, social participation/engagement, and access to resources. Interestingly, the mechanisms and pathways outlined in this framework overlap considerably with those in the religion and health research.

So missing from the socio-ecological frameworks is religion as a community-level characteristic AND missing from studies of religion and health is religion as a community-level characteristic.My dissertation tries to bridge this gap between these two areas of research.





 In the second study in Chapter 4, I look at how the religious environment is associated with individual physical health outcomes of older Chinese adults.

 And in the final study in Chapter 5, I examine potential mechanisms that explain these associations.


[SLIDE]

In the first study in Chapter 3, I examine how the religious environment in Chinese counties and prefectures is associated with county and prefecture mortality rates.

In Chapter 3, I use spatial regressions models to examine associations between the religious composition of Chinese counties and prefectures and their all-cause mortality rates. The findings suggest that the overall presence of religion in Chinese counties and prefectures is associated with population mortality. In addition, models in which different religions are examined separately, the presence of Buddhism and Islam are associated with lower mortality rates, but these associations are due to common links with the presence of ethnic minority populations. Finally, these size of the association between counties and prefectures is roughly equivalent suggesting that relationships operate similarly at different geographic scales. 

[SLIDE]
In Chapter 4, I conduct multilevel analyses examining the effects of the religious composition of Chinese prefectures on physical health outcomes of older Chinese adults. The findings from these models show that areas with a greater presence of Daoism have better self-rated health and fewer chronic illnesses. The presence of Christianity is associated with better self-rated health but not number of chronic illnesses, whereas the presence of Buddhism and Islam—in contrast to associations with lower mortality rates in Chapter 3—is associated with worse self-rated health. By controlling for respondents’ individual religious identities, these models demonstrate that religion has its own contextual effect independent of the effect of respondents’ individual religious involvement. In addition, interaction models indicate that these contextual effects are no different for religious adherents than for non-adherents, meaning that the composition of the religious environment impacts the health of older adults regardless of their religious identities.
...
[SLIDE] The first of the research questions I set out to answer with this study is how the overall religious environment impacts the physical health of older Chinese adults. So do areas with an overall stronger religious presence have different health outcomes than areas with a weaker religious presence? That's the first question we're asking here.
...
[SLIDE] I think there are several extensions of this project that could build upon these findings in the future.
