...
class:center
**.large[Predicted Self-Rated Health Based on Prefecture-level Total Sites]**
...
No evidence that greater religious presence in Chinese prefectures affects self-rated health. 
]]]
