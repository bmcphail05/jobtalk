...
**Findings**: 
  ...
  4. Effect sizes roughly equivalent between counties and prefectures. (Note: counties are nested in prefectures)
...
**Methods**: Multilevel analyses examining associations between Spatial regression models examining associations between number of religious sites and mortality rates (census data).  
