...
.pull-left[.center[.large[**Mortality rate per 1,000 people (2000)**]]
<br>
<img src= "https://github.com/bmcphail05/jobtalk/blob/main/images/mort_pref.jpg?raw=true"/>
]

.pull-right[.center[.large[**Religion with most sites per 1,000 people (2004)**]]
<br>
<img src= "https://github.com/bmcphail05/jobtalk/blob/main/images/most_pref.jpg?raw=true"/>
]

---
class: left, top

## Theoretical and Conceptual Framework (Chapter 2)

1. Conceptualization of religion as an ecological characteristic that influences individual and community-level outcomes.  
  - **religious environment**: the demographic presence and sociocultural influence of religion(s) in a local social context
...
3. Mechanisms that link religion and health
  ...
  - coping 
  - attitudes, beliefs, emotional states, and feelings 
---
...
###.opacity[Chapter 3. How is the religious environment associated with county and prefecture mortality rates in China?]

###.opacity[Chapter 4. How is the religious environment associated with the individual physical health outcomes of older Chinese adults?]

###.opacity[Chapter 5. What are potential mechanisms that explain how the religious environment impacts the physical health of  older Chinese adults?]

---
class: left, top
##.center[Chapter 3. How is the religious environment associated with county and prefecture mortality rates in China?]
**Methods**: Spatial regression models examining associations between number of religious sites and mortality rates (census data) in Chinese counties and prefectures.  

**Findings**: 
  1. Total religious sites -> lower mortality rates 
  2. Presence of Buddhism and Islam -> lower mortality rates
  3. Associations from #2 are due to common links with ethnic minority populations
  4. Effect sizes roughly equivalent across geographic scale (note: counties are nested in prefectures)


---
class: left, top
##.center[Chapter 4. How is the religious environment associated with the individual health outcomes of older adults?]
**Methods**: Multilevel analyses examining associations between number of religious sites in prefectures and individual self-rated health and number of chronic illnesses of older adults (Chinese Health and Retirement Longitudinal Study). 

**Findings**: 
  1. Presence of Daoism -> better self-rated health & fewer chronic illnesses
  2. Presence of Christianity -> better self-rated health
  3. Presence of Buddhism and Islam -> worse self-rated health  
  4. Controls for individual religious identities isolates the contextual effect
  5. Interaction models show contextual effects are no different for religious adherents than for non-adherents.

---
class:center
**.large[Predicted number of chronic illnesses for the number of Daoist sites in Chinese prefectures]**  
<br>
<img src= "https://github.com/bmcphail05/jobtalk/blob/main/images/chronic_dao.jpg?raw=true" width = "100%" />
...
**.large[Average Marginal Effects (+SD) of Daoism on Self-Rated Health]**
<br>
...
.small-font[Note: <sup>+</sup> *p* < .10, <sup>\*</sup> *p* < .05; AMEs use observed values.
]
]
...
The religious environment is an overlooked characteristic of local areas that affects health outcomes. 

The religious environment ≠ individual religion

What can we learn for developing social and cultural strategies to facilitate healthy lifestyles and better overall health outcomes?
...
Develop a study with stronger measures of potential explanatory mechanisms and include measures of social network. 

Investigate whether the religious environment impacts health outcomes via structural processes (e.g., Daoism and Traditional Chinese Medicine Hospitals) 
